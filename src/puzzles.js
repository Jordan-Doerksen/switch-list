...
export const PUZZLES = [
  ...
  },
  {
    ...
    hint: 'Your two cars are up at AS76. Line AS76 reverse and the switches below it normal, PULL them down the lead, then line AS71 and SPOT. Two moves.',
    rules: ['line', 'speed', 'couple', 'shove'],
    start: {
      AS76: [200, 'CN 210044', 'CN 210052'],
      AS73: [240, 'GATX 55110', 'GATX 55308'],
    },
    goal: { track: 'AS71', cars: ['CN 210044', 'CN 210052'] },
    par: 2,
    opt: [['pull', 'AS76', 2], ['spot', 'AS71', 2]],
  },
  {
    id: 'p0-4', tier: 0,
    title: 'Gather two',
    hint: 'One car on AS72, one on AS75 — both go to AS73. Fewer trips = fewer moves: PULL one, PULL the other onto the same cut, then SPOT both at once. Three moves.',
    rules: ['line', 'speed', 'couple', 'shove'],
    start: {
      AS72: [180, 'BNSF 8801'],
      AS75: [220, 'CP 770120'],
      AS71: [200, 'CN 41002', 'CN 41044'],
      AS76: [180, 'TILX 66108', 'TILX 66280'],
    },
    goal: { track: 'AS73', cars: ['BNSF 8801', 'CP 770120'] },
    par: 3,
    opt: [['pull', 'AS72', 1], ['pull', 'AS75', 1], ['spot', 'AS73', 2]],
  },
  {
    id: 'p1-find', tier: 1,
  ...
  },
  {
    id: 'p1-dig2', tier: 1,
    title: 'Dig it out',
    hint: 'CN 615020 is buried behind two cars on AS71. Pull the two off and stash them clear before you can get your car — then add CN 615044 from AS73 and build AS75.',
    rules: ['line', 'speed', 'couple', 'shove'],
    start: {
      AS71: [160, 'WFRX 2201', 'WFRX 2384', 'CN 615020'],
      AS73: [200, 'CN 615044', 'GATX 71200'],
      AS72: [240, ['UTLX 55110', 'tank'], ['UTLX 55284', 'tank']],
      AS76: [200, ['CEFX 44100', 'autorack']],
    },
    goal: { track: 'AS75', cars: ['CN 615020', 'CN 615044'] },
    par: 4,
    opt: [['pull', 'AS71', 3], ['pull', 'AS73', 1], ['spot', 'AS75', 2], ['spot', 'AS71', 2]],
  },
  {
    id: 'p2-list', tier: 2,
